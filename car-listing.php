        ...
        <div class="col-md-9 col-md-push-3">
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
              ...
              $sql = $dbh->query("SELECT id from tblvehicles");
              $cnt = $query->num_rows;
              ?>
          ...
          <?php $sql2 = $dbh->query("SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand");
          $cnt = 1;
          if ($sql2->num_rows > 0) {
        ...
        <aside class="col-md-3 col-md-pull-9">
              ...
              <form action="search-carresult.php" method="post">
                <div class="form-group select">
                  <select class="form-control" name="brand">
                    ...
                    <?php $sql3 = $dbh->query("SELECT * from  tblbrands ");
                    $cnt = 1;
                    if ($sql3->num_rows > 0) {
          ...
          <div class="sidebar_widget">
            ...
            <div class="recent_addedcars">
              <ul>
                <?php $sql4 = $dbh->query("SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand order by id desc limit 4");
                $cnt = 1;
                if ($sql4->num_rows > 0) {
